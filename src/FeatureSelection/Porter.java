...
public class Porter {
  ...
  public static String StemString(String input){
	  StringBuffer AfterStemming=new StringBuffer();
	  String[] a=input.split(" ");
	  Porter porter=new Porter();
	  for(int i=0;i<a.length;i++){
		  AfterStemming.append(porter.stripAffixes(a[i])+" ");
	  }
	  return AfterStemming.toString().trim();
  }
  
  public static String[] StemArgs(String[] input){
	 
	  Porter porter=new Porter();
	  for(int j=0;j<input.length;j++){
		 input[j]=porter.stripAffixes(input[j].trim()); 
	  }
  ...
  public static void main(String args[]){
		...
		//String a=StemString("I plays basketball and I played it basketballs supports");
		//System.out.println(a);
	  String[] a={"technology","functions","comp.graphics","","rec.sport.baseball"};
	  a=StemArgs(a);
	  for(int i=0;i<a.length;i++){
